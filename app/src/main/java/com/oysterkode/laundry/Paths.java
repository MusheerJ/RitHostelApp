...
public class Paths {
    ...
    public final static String STUDENT_INFO = "StudentInfo";
    public final static String COMPLAINT_STUDENTS = "Complaints/Students";
    public final static String COMPLAINT_ADMIN = "Complaints/Admin";
